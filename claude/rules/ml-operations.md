<!-- Auto-generated from cursor/rules/ml-operations.mdc — do not edit directly -->

---
paths:
  - "ImFusionLib/Include/ImFusion/ML/Operations/*.h"
  - "ImFusionLib/Source/ML/Operations/*.cpp"
---
