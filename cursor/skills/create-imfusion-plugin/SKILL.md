...
For the full invariant list, see `.cursor/rules/plugin.mdc`.
...
- See `.cursor/rules/plugin.mdc` for additional patterns
- See `.cursor/rules/cmake-guidelines.mdc` for CMake conventions
