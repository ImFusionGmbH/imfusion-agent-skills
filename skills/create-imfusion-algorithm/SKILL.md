...
For generic C++ conventions and the baseline algorithm lifecycle contract, apply `.cursor/rules/cpp-guidelines.mdc` and `.cursor/rules/algorithm-pattern.mdc`.
...
- See `.cursor/rules/algorithm-pattern.mdc` for additional patterns
- See `.cursor/rules/cpp-guidelines.mdc` for C++ conventions
