...
def test_claude_scoped_rule_starts_with_frontmatter() -> None:
	...
	assert "Generated by imfusion-sdk-agent-kit from cpp-guidelines.mdc" in rule
	assert "\n\n# C++ Guidelines\n" in rule
...
def test_claude_unscoped_rules_have_no_frontmatter() -> None:
	...
	assert rules["core-principles.md"].startswith("<!-- Generated by imfusion-sdk-agent-kit")
